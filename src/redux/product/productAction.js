...
export const listProducts = (seller="",pageNumber="",name="",category="",order="",min="",max="",rating="",)=>{
    ...
    return dispatch =>{
        ...
        Axios.get(`/api/products?pageNumber=${pageNumber}&seller=${seller}&name=${name}&category=${category}&order=${order}&min=${min}&max=${max}&rating=${rating}`)
        .then((res)=>{
            dispatch({
